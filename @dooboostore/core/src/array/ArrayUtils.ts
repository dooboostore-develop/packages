...
export namespace ArrayUtils {
  ...
  export const pickRandomSpace = (array: Space[], where: { w: number, h: number }): { x: number, y: number } | undefined => {
    ...
    //       cellSizes2D[it.y][it.x] = [cellSizes2D[it.y][it.x]];
    //     }
    //     (cellSizes2D[it.y][it.x] as typeof cellSizes[]).push(it);
    //   }
    // });
    ...
    // const cellSizes2D: typeof cellSizes[][] = [];
    // cellSizes.forEach(it => {
    //   cellSizes2D[it.y] = cellSizes2D[it.y] || [];
    //   // @ts-ignore
    //   cellSizes2D[it.y][it.x] = it;
    // });
    // console.table(cellSizes2D);
    // console.log('-----over!! ', cellSizes2D);
    ...
    // console.log('-------targetCellsEmptytargetCellsEmpty--->',ArrayUtils.pick(targetCellsEmpty))
