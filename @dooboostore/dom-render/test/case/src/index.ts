...
class Root implements OnInitRender {
  ...
  async onInitRender(param: any, rawSet: RawSet): Promise<void> {
    // setTimeout(() => {
      ...
      this.users = Array.from({length: 9999}, (_, i) => ({id: i, imgUrl: 'https://storage.googleapis.com/genview-test/generator%2Fimages%2F1%2F1763840814778-6p7gssb4utt.jpeg', office:{name:`office-${i}`}, name: `user${i}`}));
      // console.groupEnd();
