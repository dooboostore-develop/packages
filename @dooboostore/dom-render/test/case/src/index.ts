...
class Root {
  ...
  users = Array.from({length: 9}, (_, i) => ({id: i, imgUrl:'https://storage.googleapis.com/genview-test/generator%2Fimages%2F1%2F1763840814778-6p7gssb4utt.jpeg', name: `user${i}`}));
  selectedIndex = 0;
