...
export const simTest = async () => {
  ...
  // const o = simpleApplication.sim(WW);
  // console.log('aaaaaa',o)
  // o.say();

  const o = simpleApplication.sims(WW);
  console.log('aaaaaa',o)
  o.forEach(it => {
  ...
  // const nA = simpleApplication.sim(UserNormalA);
  // nA.say();
  //
  // const nB = simpleApplication.sim(UserNormalB);
  // nB.say();
