...
function generateModuleDeclarations() {
  ...
  const packageName = '@dooboostore/simple-web-component';
  ...
  switch (target) {
    ...
    case 'cjs':
      ...
      const cjsPackageJson = {
        name: '@dooboostore/simple-web-component-cjs-internal',
        private: true,
        type: 'commonjs'
      };
      ...
      await performBuild(
        {
          ...
          outfile: path.resolve(__dirname, 'dist', 'umd-bundle', 'dooboostore-simple-web-component.umd.js'),
          format: 'iife',
          globalName: 'dooboostoreSimpleWebComponent',
      ...
      await performBuild(
        {
          ...
          bundle: true,
          entryPoints: [path.resolve(srcDir, 'bundle-entry.ts')],
          outfile: path.resolve(__dirname, 'dist', 'esm-bundle', 'dooboostore-simple-web-component.esm.js'),
          format: 'esm',
