import swcRegister, { changedAttributeHost, elementDefine, onConnectedInnerHtml, attribute, attributeHost, query } from '@dooboostore/simple-web-component';
