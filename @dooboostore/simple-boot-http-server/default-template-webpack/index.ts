...
export class AppRouter {
  ...
  @Route({path: '/resources/img.png'})
  @GET({resolver: ResourceResorver})
  img(rr: RequestResponse, header: ReqHeader, routerModule: RouterModule) {
  }

  @Route({path: '/json'}) @POST({res: {contentType: Mimes.ApplicationJson}})
  jsonPost(rr: RequestResponse, header: ReqHeader, routerModule: RouterModule) {
    return {name: 'visualkhh222post'}
  }
