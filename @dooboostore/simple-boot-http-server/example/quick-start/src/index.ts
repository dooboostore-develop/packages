...
export class AppRouter {
    ...
    @Route({path: '/data'}) @GET({resolver: ResourceResolver})
    ...
    @Route({path: '/resources/index.css'}) @GET({resolver: ResourceResolver})
    css(rr: RequestResponse, header: ReqHeader, routerModule: RouterModule) {
    }

    @Route({path: '/resources/img.png'}) @GET({resolver: ResourceResolver})
    img(rr: RequestResponse, header: ReqHeader, routerModule: RouterModule) {
    }
