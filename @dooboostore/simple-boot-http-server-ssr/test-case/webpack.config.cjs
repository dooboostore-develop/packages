...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@dooboostore/dom-parser': path.resolve(__dirname, '../../../@dooboostore/dom-parser/src'),
      '@dooboostore/simple-web-component': path.resolve(__dirname, '../../../@dooboostore/simple-web-component/src'),
    },
