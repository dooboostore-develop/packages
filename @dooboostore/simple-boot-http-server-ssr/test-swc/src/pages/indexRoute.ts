import {addEventListener, insertBeforeEndLight, attributeThis, createElement, CreateElementConfig, elementDefine, onConnected, onConnectedBefore, onInitialize, attribute} from '@dooboostore/simple-web-component';
